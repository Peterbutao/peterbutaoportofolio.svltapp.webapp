...
export const services: Service[] = [
  {
    ...
    link:  { label: 'VIEW ON LINKEDIN', href: 'https://www.linkedin.com/in/peter-butao-7238471b4/' },
  ...
  },
  {
    ...
    link:  { label: 'VIEW ON GITHUB', href: 'https://github.com/Peterbutao' },
    icon:  `<svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
  ...
  },
  {
    ...
    link:  { label: 'LEARN MORE', href: 'https://www.linkedin.com/in/peter-butao-7238471b4/' },
    icon:  `<svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
